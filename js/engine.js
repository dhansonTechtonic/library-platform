...
books with that title. If there are then return false and don't add a book
If there aren't then add the book to the bookShelf array. Then send the updates
to the localStorage and return true to make sure the book was added.
*/
...
book that matches the title that was inputted. If there is then I want to remove
that book from my array, update localStorage, and return true. If there is not
...
array then I want to return that random book title. If there are not then I want
to return null.
*/
...
have all or some of what was inputted. If there is then I want to add those
books to the array and return the array.
*/
...
/*
addBooks: I want to start a count of how many books are added to my bookShelf. I
want to add books using my addBook function. I want to loop through the array of
books that are added and count one for each book added. Then I want to save to
localStorage and return how many books were added.
*/
...
/*
getAuthors: I want to create an array that displays all the authors. If there are no
books in the bookShelf return foundAuthors(nothing). If there are books then add the
first author to the array to initiate the loop. Then I want to loop through my bookShelf
and through my foundAuthors and see if they have any names that aren't in foundAuthors
then add them. If they are there then skip over them. Then return the authors.
*/
...
strings. Then I want to create an array for my results. Then I want to loop
through the strings and use getBookByTitle and getBookByAuthor to push books
that match those strings. Then I want to create a new array that merges results
and filters through and get rid of duplicates. Then return the merged results.
*/
...
and make it an object again. Then I want to loop through the bookShelf and
make that new object a book so it can be updated.
*/
